...
{% if current_user.is_authenticated %}
  <div class='box'>
    ...
    {% if uploaded %}
      ...
      <a href="https://pollo.ai/animate-a-picture" target="_blank">✨ Animate Now</a>
    {% endif %}
    <p><a href="/logout">Logout</a></p>
    {% if current_user.email == admin %}
      <p><a href="/admin">View All Users</a></p>
    {% endif %}
    <p><a href="/donate"><button>Buy Me a Tea and Snacks (₹1)</button></a></p>
  </div>
{% else %}
  <div class='box'>
...
def donate():
    ...
    return render_template_string(STYLE + f"""
        <h2>Support Me ☕🍪</h2>
        <div class='box'>
            <p>Pay ₹1 via UPI to:</p>
            <p><b>{upi_id}</b></p>
            <a href="{upi_url}">
                <button>Pay via UPI App (₹1)</button>
            </a>
            <br><br>
            <img src="https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl={upi_url}" alt="Scan to Pay"/>
            <p>After payment, click below:</p>
            <a href="/thanks"><button>Payment Done</button></a>
        </div>
    """)
